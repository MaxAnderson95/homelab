high-availability {
    vrrp {
        group management {
            ...
            hello-source-address 10.100.150.3
            interface eth1.150
            no-preempt
            peer-address 10.100.150.2
            priority 100
            vrid 150
        }
        group nsx-rtep {
            ...
            hello-source-address 10.100.176.3
            interface eth1.176
            no-preempt
            peer-address 10.100.176.2
            priority 100
            vrid 176
        }
        group nsx-tep {
            ...
            hello-source-address 10.100.175.3
            interface eth1.175
            no-preempt
            peer-address 10.100.175.2
            priority 100
            vrid 175
        }
        group servers {
            ...
            hello-source-address 10.100.161.3
            interface eth1.161
            no-preempt
            peer-address 10.100.161.2
            priority 100
            vrid 161
        }
        group vip {
            ...
            hello-source-address 10.100.55.3
            interface eth1.55
            no-preempt
            peer-address 10.100.55.2
            priority 100
            vrid 55
        }
    }
...
interfaces {
    ...
    ethernet eth1 {
        ...
        vif 55 {
            address 10.100.55.3/24
            description vip
        }
        vif 150 {
            address 10.100.150.3/24
            description management
        }
        vif 161 {
            address 10.100.161.3/24
            description servers
        }
        vif 174 {
            address 10.100.174.1/24
            description nsx-t0-uplink-2
        }
        vif 175 {
            address 10.100.175.3/24
            description nsx-tep
        }
        vif 176 {
            address 10.100.176.3/24
