...
interfaces {
    ethernet eth0 {
        ...
        description OUTSIDE
        hw-id 00:0c:29:6b:24:77
    }
    ethernet eth1 {
        address 10.100.1.1/24
        description INSIDE
        hw-id 00:0c:29:6b:24:81
    }
    loopback lo {
    }
    tunnel tun0 {
...
system {
    ...
    login {
        ...
        user vyos {
            authentication {
                encrypted-password $6$w2cMsas.dbwSECLl$E1qmwZAsEDT125qhQ1M80uRnrTmATpj1J.J.SLfarzkxhhFY0xPOnBbRXWjoWfm.uKwdKQYygzDKwTF8GpuaK0
                plaintext-password ""
            }
        }
    }
